...
<div class="max-w-6xl mx-auto px-4 space-y-12 text-gray-900">
  ...
  <section data-aos="fade-up">
    ...
    <p class="leading-relaxed">
      We organise friendly games against other universities' development squads to build confidence, culminating in the excitement of the Roses development match each Summer term.
    </p>
  </section>
  ...
  <section class="grid grid-cols-1 md:grid-cols-2 gap-8" data-aos="fade-up">
    <div>
      ...
      <ul class="list-disc list-inside space-y-2">
        <li>Tuesday 5-6pm – Skill Development</li>
        <li>Thursday 5-6pm – Tactical Play</li>
      </ul>
    </div>
    <div>
