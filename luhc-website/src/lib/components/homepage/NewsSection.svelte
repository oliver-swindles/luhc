  ...
  <div class="grid grid-cols-1 items-center gap-8 md:grid-cols-2">
    ...
    <div class="space-y-4">
      <p>
        ...
        clubs on campus. We have three men's and three women's teams. Both our 1st and 2nd XI's
        compete in the BUCS (British university and college sport) Wednesday leagues, and our 1st
        XIs & 3rd XIs compete in Saturday league. We boast an impressive development squad for
        members who would like to play recreationally, as well as members who wish to develop their
        game and progress into the competitive teams. We host socials every Wednesday and have two
        formal dinners each year.
      </p>
