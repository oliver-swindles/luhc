<script>
  ...
  const captains = [
    ...
    { role: "Women's 1s Captain", name: '...', photo: '' },
    { role: "Women's 1s Vice-captain", name: '...', photo: ''},
    { role: "Men's 2s Captain", name: '...', photo: '' },
    { role: "Men's 2s Vice-captain", name: 'Samuel Choi', photo: '' },
    { role: "Women's 2s Captain", name: '...', photo: '' },
    { role: "Women's 2s Vice-captain", name: '...', photo: '' },
    { role: "Men's 3s Captain", name: 'Matt Grimshaw', photo: '' },
    { role: "Men's 3s Vice-captain", name: 'Tom Baker', photo: '' },
    { role: "Women's 3s Captain", name: '...', photo: '' },
    { role: "Women's 3s Vice-captain", name: '...', photo: '' },
    { role: "Indoor Captain", name: '...', photo: '' },
