<script lang="ts">
  ...
  let data = {
    mensLinks: {
      title: "Lancaster Uni Men's Hockey",
      ...
      sections: [
        {
          ...
          links: [
            // {
            //   "name": "Buy Membership",
            //   "url": "https://lancastersu.co.uk/groups/hockey-mixed-e3ed/join"
            // },
            {
              "name": "Hockey | Roses Live",
              "url": "https://roseslive.co.uk/activities/hockey"
            },
            // {
            //   "name": "LUHC Website",
        ...
        },
        {
          ...
          "links": [
            {
              "name": "LUHC Facebook",
              "url": "https://www.facebook.com/groups/340322369353793/"
            },
            {
              "name": "Men's Instagram",
              "url": "https://www.instagram.com/lumhc_"
            },
            {
              "name": "Men's TikTok",
              "url": "https://www.tiktok.com/@lumhc_"
            }
          ]
        }
      ]
...
<svelte:head>
  <title>LUHC Men's Links</title>
  <meta name="description" content="Official links for the Lancaster University Hockey Club Men's team." />
</svelte:head>
...
<div class="max-w-6xl mx-auto px-4 text-gray-900">
  <div class="max-w-2xl mx-auto py-12">
    ...
    {#each data.mensLinks.sections as section}
      <section class="mb-8">
          ...
          {#each section.links as link}
            <li>
              <a 
                ...
                class="block w-full text-center px-6 py-4 rounded-lg bg-red-800 text-white hover:bg-red-700 transition-colors duration-200 shadow-md font-medium"
              >
                {link.name}
              </a>
            </li>
