...
<svelte:head>
  ...
  <meta
    name="description"
    content="Official links for the Lancaster University Hockey Club Men's team."
  />
</svelte:head>
...
<div class="mx-auto max-w-6xl px-4 text-gray-900">
  <div class="mx-auto max-w-2xl py-12">
    ...
    <ul class="mb-8 flex w-full items-center justify-center gap-6">
      <li>
        <Button.Root href="https://www.instagram.com/luhc_dev/">
          <svg
            class="text-profileTitleText"
            fill="currentColor"
            height="32"
            viewBox="0 0 24 24"
            width="32"
      ...
      <li>
        <Button.Root href="https://www.facebook.com/share/g/1E9scZeJvp">
          <svg
            class="text-profileTitleText"
            fill="currentColor"
            height="32"
    ...
    <!-- <section class="mb-8">
      ...
      <Button.Root href={data.mensLinks.sections[0].links[0].url} class="block w-full rounded-2xl overflow-hidden relative pb-[56.25%] group">
        <div 
    ...
    {#each data.mensLinks.sections as section (section.title)}
      <section class="mb-8">
        <h3 class="mb-4 text-center text-xl font-semibold">{section.title}</h3>
        <ul class="space-y-4">
          {#each section.links as link (link.url)}
            <li>
              <Button.Root
                class="block w-full rounded-lg bg-red-800 px-6 py-4 text-center font-medium text-white shadow-md transition-colors duration-200 hover:bg-red-700"
                href={link.url}
