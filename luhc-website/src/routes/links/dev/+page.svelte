<script lang="ts">
  ...
  let data = {
    mensLinks: {
      title: "Lancaster Uni Dev Hockey",
      description: "Mixed Gender Recreational Hockey for all abilities!",
      sections: [
        {
          title: "Important Links",
          links: [
            {
                "name": "2025/26 Dev Chat",
                "url": "https://m.me/ch/AbbhSSTYL3unKjM1"
            },
            {
                "name": "Dev Facebook Group",
                "url": "https://www.facebook.com/share/g/1E9scZeJvp"
            }
          ]
        ...
        },
        {
            ...
            "links": [
                {
                    "name": "Roses 2023 Livestream",
                    "url": "https://www.youtube.com/live/_Pp9nm9srcc"
                }
            ]
        },
        {
        ...
        },
        {
          ...
          "links": [
            {
              "name": "Dev Instagram",
              "url": "https://www.instagram.com/luhc_dev"
            },  
            {
              "name": "LUHC Facebook",
...
<svelte:head>
  <title>LUHC Dev Squad Links</title>
...
<div class="max-w-6xl mx-auto px-4 text-gray-900">
  <div class="max-w-2xl mx-auto py-12">
    ...
    <p class="text-center mb-4 max-w-[40ch] mx-auto">{data.mensLinks.description}</p>

    <ul class="flex w-full items-center justify-center gap-6 mb-8">
        <li><a href="https://www.instagram.com/luhc_dev/">
        ...
        <li><a href="https://www.facebook.com/share/g/1E9scZeJvp">
